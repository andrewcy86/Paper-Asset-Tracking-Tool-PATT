...
if (!class_exists('Patt_Custom_Func')) {
    ...
    class Patt_Custom_Func
    {
        ...
        public function fetch_shelf( $id )
        {
            // global $wpdb;
            $array = array();
        ...
        public function fetch_create_date( $id )
        {
            global $wpdb;
        ...
        public function fetch_request_key( $id )
        {
            global $wpdb;
        ...
        //Function to obtain request key
        public function fetch_box_count( $id )
        {
            global $wpdb;
